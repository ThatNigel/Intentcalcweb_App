...
fun Intent_Screen(navController: NavHostController) {
    ...
    Column (verticalArrangement = Arrangement.Top,
        ...
        OutlinedButton(
            onClick = {
                val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" +"0769759883 "))
        ...
        OutlinedButton(onClick = {
            val uri = Uri.parse("smsto:0769759883")
        ...
        OutlinedButton(
            onClick = {
                val emailIntent=
                    Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","omondinigel@gmail.com",null))
